...
public static class QualityRules
{
    ...
    /// <summary>Piecewise linear: skill 0 -> 0.2, 50 -> 0.6, 100 -> 1.0. Redo bonus +0.05 per redo, capped at 1.0.</summary>
    public static double SkillFactor(int skill, int redoCount = 0)
    {
    ...
    public static double Contribution(Stage stage, int skill, double overtimeHours, double hoursRequired, int redoCount)
    {
        var skillFactor = SkillFactor(skill, stage == Stage.Name ? redoCount : 0);
