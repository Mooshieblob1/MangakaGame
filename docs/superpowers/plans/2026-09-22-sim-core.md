...
- [ ] **Step 2: Replace the generated csproj files**
...
- [ ] **Step 5: Implement GameEvent and payload types**
...
- [ ] **Step 3: Implement the work step**
...
- [ ] **Step 3: Implement the risk step**
...
- [ ] **Step 3: Implement recap and idle-skip query**
...
- [ ] **Step 3: Implement commands and Apply**
...
- [ ] **Step 2: Add the project to the solution and build**
...
- [ ] **Step 3: Import and run headless in Godot**
...
- [ ] **Step 3: Manual checklist in the editor**
...
Check each item and fix anything that fails before committing:
1. Clock shows `Mon 1996-04-01 08:00` and `Paused`. Chapter table is empty, the person panel shows Aki idle, the log shows the first `DayStarted` and `WeekStarted` events.
...
5. Pin a later stage, confirm it jumps to the top and becomes current; unpin restores order. Up/Down swap rows; after the next `DayStarted` the manual order is gone. Skip marks a stage done at zero hours and logs `StageSkipped`.
